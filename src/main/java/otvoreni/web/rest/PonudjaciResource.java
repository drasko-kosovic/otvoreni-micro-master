...
import otvoreni.repository.PonudjaciRepository;
...
/**
 * REST controller for managing {@link otvoreni.domain.Ponudjaci}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class PonudjaciResource {
    ...
    private static final String ENTITY_NAME = "otvoreniPonudjaci";
    ...
    public ResponseEntity<List<Ponudjaci>> getAllPonudjacis(Pageable pageable) {
        log.debug("REST request to get a page of Ponudjacis");
        Page<Ponudjaci> page = ponudjaciRepository.findAll(pageable);
