...
/**
 * REST controller for managing {@link otvoreni.domain.Ugovor}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class UgovorResource {
    ...
    private static final String ENTITY_NAME = "otvoreniUgovor";
     ...
     */
    @PostMapping("/ugovors")
    public ResponseEntity<Ugovor> createUgovor(@RequestBody Ugovor ugovor) throws URISyntaxException {
    ...
    public ResponseEntity<Ugovor> updateUgovor(@PathVariable(value = "id", required = false) final Long id, @RequestBody Ugovor ugovor)
        ...
        Optional<Ugovor> result = ugovorRepository
            ...
            .map(
                existingUgovor -> {
                    ...
                    if (ugovor.getBrojOdluke() != null) {
                        existingUgovor.setBrojOdluke(ugovor.getBrojOdluke());
                    }
                    if (ugovor.getDatumOdluke() != null) {
                        existingUgovor.setDatumOdluke(ugovor.getDatumOdluke());
                    }
     ...
     */
    @GetMapping("/ugovors")
    public ResponseEntity<List<Ugovor>> getAllUgovors(Pageable pageable) {
        log.debug("REST request to get a page of Ugovors");
        Page<Ugovor> page = ugovorRepository.findAll(pageable);
