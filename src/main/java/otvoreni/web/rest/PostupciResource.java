...
import otvoreni.domain.Postupci;
import otvoreni.repository.PostupciRepository;
...
/**
 * REST controller for managing {@link otvoreni.domain.Postupci}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class PostupciResource {
    ...
    private static final String ENTITY_NAME = "otvoreniPostupci";
    ...
    public ResponseEntity<List<Postupci>> getAllPostupcis(Pageable pageable) {
