...
import otvoreni.repository.SpecifikacijeRepository;
...
/**
 * REST controller for managing {@link otvoreni.domain.Specifikacije}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class SpecifikacijeResource {
    ...
    private static final String ENTITY_NAME = "otvoreniSpecifikacije";
    ...
    public ResponseEntity<List<Specifikacije>> getAllSpecifikacijes(Pageable pageable) {
