...
public class ViewPrvorangiraniResource {
    ...
    public List<ViewPrvorangirani> findByPostupakPrvorangirani(@PathVariable Integer sifraPostupka) {
        return viewPrvorangiraniRepository.findBySifraPostupka(sifraPostupka);
    }

    @GetMapping("/prvorangirani-ponude/{sifraPonude}")
    public List<ViewPrvorangirani> findByPonudePrvorangirani(@PathVariable Integer sifraPonude) {
        return viewPrvorangiraniRepository.findBySifraPonude(sifraPonude);
    }

    @GetMapping("/prvorangirani/ugovor")
    public List<ViewPrvorangirani> findByPrvorangiraniUgovor(@RequestParam Integer sifraPostupka, Integer sifraPonude) {
        return viewPrvorangiraniRepository.findBySifraPostupkaAndSifraPonude(sifraPostupka,sifraPonude);
    }
}
