...
import otvoreni.repository.HvalePonudeRepository;
import otvoreni.web.rest.errors.BadRequestAlertException;
import tech.jhipster.web.util.HeaderUtil;
import tech.jhipster.web.util.ResponseUtil;

/**
 * REST controller for managing {@link otvoreni.domain.HvalePonude}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class HvalePonudeResource {
    ...
    private static final String ENTITY_NAME = "otvoreniHvalePonude";
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/hvale-ponudes/{id}", consumes = "application/merge-patch+json")
